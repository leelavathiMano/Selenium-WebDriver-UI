...
public class Synchronization_waitcode {
  public static void main(String[] args) {
    ...
    System.out.println(
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("h1[class='my-4']"))).getText());
    try {
      Thread.sleep(3000);
    ...
    System.out.println(
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("button.btn.btn-success"))).getText());
  }
}
